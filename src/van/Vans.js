...
import '../index.css'
import {Link, NavLink, useSearchParams, useLoaderData, defer, Await} from "react-router-dom";
...
export function loader() {
    ...
    const vanPromise = getVans()
    return defer({vans: vanPromise})
    // return getVans()
}
...
const Vans = () => {
    ...
    return (
        <div className="van-list-container">
            ...
            <React.Suspense fallback={<div style={{display: 'flex', justifyContent: 'center', fontSize: '1.5rem'}}>Loading Vans...</div>}>
